      ...
      <div className="hidden lg:flex justify-between items-center py-4 w-full px-6 max-w-[1400px] mx-auto gap-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-6 border-r border-gray-200 pr-6 h-8">
            <Link
              href="/about"
              className="flex items-center gap-2 text-gray-700 hover:text-primary transition-colors font-medium text-sm uppercase tracking-wide"
            >
              <Star size={18} />
          ...
          {user ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="gap-2 rounded-full border-primary/20 hover:bg-primary/5 hover:text-primary px-4 h-10"
                >
                  <User2 size={18} />
